...
# CONFIGURATION
# -----------------------------
BASE_SECTION_URL = "https://secretnyc.co/culture/page/{}/"
SCRIPT_DIR = os.path.dirname(__file__)
ROOT_DIR = os.path.dirname(SCRIPT_DIR)
OUTPUT_PATH = os.path.join(SCRIPT_DIR, "mementos_culture_all_pages.json")
...
TOTAL_KNOWN_PAGES = 184  # Total pages from the Culture section
...
def get_total_pages() -> int:
    ...
    try:
        ...
        logging.warning("Could not detect pages, using known total of 184")
        return TOTAL_KNOWN_PAGES
    except Exception as e:
        logging.error(f"Error getting total pages: {e}")
        logging.warning("Using known total of 184 pages")
        return TOTAL_KNOWN_PAGES
...
def scrape_article(article_url: str) -> Optional[Dict]:
    ...
    try:
        ...
        # ✅ Indoor filter - Modified for culture to allow museums and galleries
        indoor_keywords = [
            # Dining and Nightlife (non-cultural)
            ...
            # Entertainment Centers (non-cultural)
            ...
            # Descriptive Terms (excluding cultural indoor spaces)
