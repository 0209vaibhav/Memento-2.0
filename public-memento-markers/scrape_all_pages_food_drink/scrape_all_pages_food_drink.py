...
# CONFIGURATION
# -----------------------------
BASE_SECTION_URL = "https://secretnyc.co/food-drink/page/{}/"
SCRIPT_DIR = os.path.dirname(__file__)
ROOT_DIR = os.path.dirname(SCRIPT_DIR)
OUTPUT_PATH = os.path.join(SCRIPT_DIR, "mementos_food_drink_all_pages.json")
...
TOTAL_KNOWN_PAGES = 194  # Total pages from the Food & Drink section
...
def get_total_pages() -> int:
    ...
    try:
        ...
        logging.warning("Could not detect pages, using known total of 194")
        return TOTAL_KNOWN_PAGES
    except Exception as e:
        logging.error(f"Error getting total pages: {e}")
        logging.warning("Using known total of 194 pages")
        return TOTAL_KNOWN_PAGES
...
def scrape_article(article_url: str) -> Optional[Dict]:
    ...
    try:
        ...
        # ✅ Indoor filter - Modified for food & drink to allow some indoor venues
        indoor_keywords = [
            # Excluded Entertainment Venues (non-food related)
            "theater", "theatre", "cinema", "movie", "screening", "gallery", "museum",
            "auditorium", "concert hall", "stage", "performance", "show", "play", 
            "musical", "opera",

            # Shopping and Retail (non-food)
            ...
            # Descriptive Terms (excluding food-related indoor spaces)
            "interior", "covered", "enclosed", "under roof", "climate controlled", 
