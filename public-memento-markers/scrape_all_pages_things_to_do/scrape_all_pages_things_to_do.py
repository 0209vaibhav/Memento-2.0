...
# CONFIGURATION
# -----------------------------
BASE_SECTION_URL = "https://secretnyc.co/things-to-do/page/{}/"
SCRIPT_DIR = os.path.dirname(__file__)
ROOT_DIR = os.path.dirname(SCRIPT_DIR)
OUTPUT_PATH = os.path.join(SCRIPT_DIR, "mementos_things_to_do_all_pages.json")
...
TOTAL_KNOWN_PAGES = 326  # Total pages from the website
...
def get_total_pages() -> int:
    ...
    try:
        ...
        logging.warning("Could not detect pages, using known total of 326")
        return TOTAL_KNOWN_PAGES
    except Exception as e:
        logging.error(f"Error getting total pages: {e}")
        logging.warning("Using known total of 326 pages")
        return TOTAL_KNOWN_PAGES
...
def scrape_article(article_url: str) -> Optional[Dict]:
    ...
    try:
        ...
        # ✅ Indoor filter
        indoor_keywords = [
            "indoor", "inside", "theatre", "cinema", "gallery", "museum", "library", "exhibit", "auditorium",
            "restaurant", "cafe", "bar", "club", "concert hall", "theater", "studio", "mall", "shopping center",
            "store", "shop", "market", "arena", "stadium", "bowling alley", "arcade", "aquarium", "zoo",
            "planetarium", "observatory", "conservatory", "greenhouse", "hotel", "resort", "spa", "salon",
            "gym", "fitness center", "pool", "ice rink", "skating rink", "roller rink", "trampoline park",
            "escape room", "virtual reality", "vr", "arcade", "game room", "playground", "indoor playground"
        ]
